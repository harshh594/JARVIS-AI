...
# Set the correct voice from the list of available voices
AssistantVoice = "en-US-GuyNeural"  # Update this with the correct voice name
...
def TextToSpeech(Text, func=lambda r=None: True):
    ...
    if len(Data) > 4 and len(Text) >= 250:
        ...
        # First two sentences + response message
        TTS(" ".join(Text.split(".")[0:2]) + "." + " " + response_message, func)
